...
/**
 * The RentalRepository class provides CRUD operations for managing Rental
 * records. It maintains an in-memory list of Rental objects and supports
 * operations such as addition, retrieval, update, and deletion. In addition, it
 * includes methods to serialize and deserialize the rental list to and from a
 * file.
 */
public class RentalRepository implements Serializable {
	 ...
	 *
	 * @param filename the path and name of the file to which rental data will be
	 *                 saved.
	 */
	 ...
	 *
	 * @param filename the path and name of the file from which rental data will be
	 *                 loaded.
	 */
