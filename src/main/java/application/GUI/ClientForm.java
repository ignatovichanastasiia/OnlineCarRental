...
import application.controllers.ClientFormController;
...
public class ClientForm {
	public void startClientForm(Stage primaryStage, AppContext context) {
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getResource("/design_client_form.fxml"));
		    System.out.println(loader.toString());
		    //AppContext context, CardService cardService, RentalService rentalService
		    ClientFormController controller = new ClientFormController(context, context.getCardService(), context.getRentalService());
...
//ИНИЦИАЛИЗАЦИЯ КОНСТРУКТОРА С ПАРАМЕНТРАМИ!! 
//try {
